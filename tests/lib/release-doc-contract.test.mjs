...
test("readme files describe the current Codex config surface and current test count", () => {
  for (const path of ["README.md", "README.ko.md"]) {
    const body = read(path);
    assert.match(body, /2151\/2151/);
    assert.doesNotMatch(body, /2150\/2150|2150%20passing|2150 tests|2037\/2037|2037%20passing|2037 tests|2026\/2026|2026%20passing|2026 tests|2011\/2011|2011%20passing|2011 tests|1991\/1991|1991%20passing|1991 tests/);
