...
test("operational hardening docs record implemented release-audited status", () => {
  ...
  assert.match(plan, /node --test[\s\S]{0,120}1696\/1696/);
  assert.match(plan, /release-smoke\.sh --fast --with-live-cli[\s\S]{0,120}326\/326/);
