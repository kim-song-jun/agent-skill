...
test("readme files describe the current Codex config surface and current test count", () => {
  for (const path of ["README.md", "README.ko.md"]) {
    const body = read(path);
    assert.match(body, /2352\/2352/);
    assert.doesNotMatch(body, /2332\/2332|2332%20passing|2332 tests|2329\/2329|2329%20passing|2329 tests|2302\/2302|2302%20passing|2302 tests|2278\/2278|2278%20passing|2278 tests|2258\/2258|2258%20passing|2258 tests|2246\/2246|2246%20passing|2246 tests|2205\/2205|2205%20passing|2205 tests|2202\/2202|2202%20passing|2202 tests|2151\/2151|2151%20passing|2151 tests|2150\/2150|2150%20passing|2150 tests|2037\/2037|2037%20passing|2037 tests|2026\/2026|2026%20passing|2026 tests|2011\/2011|2011%20passing|2011 tests|1991\/1991|1991%20passing|1991 tests/);
    ...
    assert.match(body, /harness-builder[\s\S]{0,120}v0\.7\.17/i);
    assert.match(body, /harness-floor[\s\S]{0,120}v0\.7\.17/i);
    assert.match(body, /(other 17 installable|나머지 설치 가능한)[\s\S]{0,180}v0\.7\.17/i);
