...
test("operational hardening docs record implemented release-audited status", () => {
  ...
  assert.match(plan, /node --test[\s\S]{0,120}1685\/1685/);
  assert.match(plan, /release-smoke\.sh --fast --with-live-cli[\s\S]{0,120}315\/315/);
