...
test("operational hardening docs record implemented release-audited status", () => {
  ...
  assert.match(plan, /node --test[\s\S]{0,120}1784\/1784/);
  assert.match(plan, /release-smoke\.sh --fast --with-live-cli[\s\S]{0,120}446\/446/);
  ...
  assert.match(changelog, /1784\/1784 passing/);
  assert.match(changelog, /446\/446 passing/);
  ...
  assert.match(changelogKo, /1784\/1784 통과/);
  assert.match(changelogKo, /446\/446 통과/);
