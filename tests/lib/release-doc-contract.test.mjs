...
test("operational hardening docs record implemented release-audited status", () => {
  ...
  assert.match(plan, /Claude 60\/60 and Codex 66\/66 readiness checks passing/i);
  ...
  assert.match(plan, /node --test[\s\S]{0,120}1776\/1776/);
  ...
  assert.match(changelog, /1776\/1776 passing/);
  ...
  assert.match(changelogKo, /1776\/1776 통과/);
