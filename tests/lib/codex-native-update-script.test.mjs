...
if [ "$*" = "plugin list" ]; then
  cat <<'EOF'
harness-builder-codex@agent-skill installed, enabled 0.6.11
harness-floor-codex@agent-skill installed, enabled 0.6.11
harness-thrift-codex@agent-skill installed, enabled 0.6.11
harness-debug-codex@agent-skill installed, enabled 0.6.11
EOF
  exit 0
fi
exit 0
