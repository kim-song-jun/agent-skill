...
test("release-candidate report validates current checkout evidence", () => {
  ...
  assert.equal(report.plugins.manifests.find((plugin) => plugin.name === "harness-builder").version, "0.6.14");
  assert.equal(report.plugins.manifests.find((plugin) => plugin.name === "harness-floor").version, "0.6.14");
