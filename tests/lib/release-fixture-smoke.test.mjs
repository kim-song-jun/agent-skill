...
test("release fixture smoke validates Claude dry-run and Codex fresh fixtures", () => {
  ...
  assert.match(result.checks.claudePlatform.summary, /Claude platform fixture: ok \(26\/26 artifacts\)/);
  ...
  assert.match(result.checks.claudePlatform.details, /Enterprise Django\/Vue routing proof/);
  assert.match(result.checks.claudePlatform.details, /no HOME patching/);
  assert.match(result.checks.claudePlatformBuilder.summary, /Claude platform builder fixture: ok \(28\/28 file checks\)/);
  ...
  assert.match(result.checks.claudePlatformLite.summary, /Claude platform lite fixture: ok \(26\/26 file checks\)/);
  ...
  assert.match(result.checks.claudeUninstall.summary, /Claude uninstall fixture: ok \(14\/14 removals\)/);
  ...
  assert.match(result.checks.claudeForceRootClean.summary, /Claude force-root uninstall fixture: ok \(16\/16 removals\)/);
  ...
  assert.match(result.checks.codexOperational.summary, /Codex operational fixture: ok \(28\/28 artifacts\)/);
  ...
  assert.match(result.checks.codexOperational.details, /Enterprise Django\/Vue routing proof/);
  ...
  assert.match(result.checks.codexOperational.details, /sequential \/agent-all prompt helper runs from the installed fixture/);
  assert.match(result.checks.codexOperational.details, /sequential \/visual-qa page helper runs from the installed fixture/);
  ...
  assert.match(result.checks.codexBuilder.summary, /Codex builder fixture: ok \(30\/30 file checks\)/);
  ...
  assert.match(result.checks.codexFloor.summary, /Codex floor fixture: ok \(20\/20 file checks\)/);
  assert.match(result.checks.codexFloor.details, /only Codex floor artifacts/);
  assert.match(result.checks.codexFloor.details, /sequential \/agent-all helper runtime/);
  assert.match(result.checks.codexFloor.details, /sequential \/visual-qa helper runtime/);
  assert.match(result.checks.codexThrift.summary, /Codex thrift fixture: ok \(20\/20 file checks\)/);
  ...
  assert.match(result.checks.codexDebug.details, /only \/debug artifacts/);
  assert.match(result.checks.codexDebug.details, /post-install debug doctor coverage/);
  assert.match(result.checks.codexUninstall.summary, /Codex uninstall fixture: ok \(16\/16 removals\)/);
  ...
  assert.match(result.checks.codexForceRootClean.summary, /Codex force-root uninstall fixture: ok \(17\/17 removals\)/);
