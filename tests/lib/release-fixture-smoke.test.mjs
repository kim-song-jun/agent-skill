...
test("release fixture smoke validates Claude dry-run and Codex fresh fixtures", () => {
  ...
  assert.match(result.checks.codexOperational.summary, /Codex operational fixture: ok \(27\/27 artifacts\)/);
  ...
  assert.match(result.checks.codexBuilder.summary, /Codex builder fixture: ok \(29\/29 file checks\)/);
