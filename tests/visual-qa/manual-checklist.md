...
- [ ] First successful run produces `.agent-skill/reports/visual-qa/YYYY-MM-DD-<hex>/` with: `report.md`, `report.json`, `home/mobile/_page.png`, `home/desktop/_page.png`, `home/*/cta__default.png`, `home/*/cta__hover.png`, `home/*/cta__focus.png`.
