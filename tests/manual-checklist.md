...
- Fresh release fixture coverage for Claude marketplace dry-run, Claude operational/lite render output, Claude terminal `install-platform.sh --platform=claude` operational/lite installs, and Codex operational/lite/builder/floor/thrift/debug installs in new git repos.
