...
const LOCAL_DEPLOY_CONTRACT = {
  ...
  patterns: [
    ...
    /node scripts\/release-candidate\.mjs --date=2026-06-12/,
...
const USER_OBJECTIVE_RELEASE_MATRIX = {
  ...
  patterns: [
    ...
    /Enterprise Django\/Vue routing[\s\S]{0,260}Django\/Vue monorepo routing/,
...
const PLATFORM_CONTRACTS = {
  claude: {
    ...
    requiredFiles: [
      ...
      "plugins/harness-builder/skills/agent-init/templates/agents/reviewer.md.hbs",
    ...
    textChecks: [
      ...
      {
        file: "plugins/harness-builder/skills/agent-init/templates/agents/reviewer.md.hbs",
        patterns: [/Review Task/, /VERIFICATION_AUDIT: passed/, /VERIFICATION_AUDIT: failed/, /VERIFICATION_AUDIT: skipped/, /literal line at the END/i],
      },
      {
      ...
      },
      {
        ...
        patterns: [/QA Review Task/, /QA_AUDIT: passed/, /QA_AUDIT: failed/, /QA_AUDIT: skipped/, /literal line at the END/i],
      },
      {
        file: "plugins/harness-builder/skills/agent-init/templates/agents/integration-dev.md.hbs",
      ...
      {
        file: "plugins/harness-builder/skills/agent-init/templates/agents/design-reviewer.md.hbs",
      ...
      {
        file: "plugins/harness-builder/skills/agent-init/templates/agents/security-reviewer.md.hbs",
      ...
      {
        file: "plugins/harness-builder/skills/agent-init/templates/agents/data-reviewer.md.hbs",
      ...
      },
      {
        ...
        patterns: [
          ...
          /checkClaudePlatformBuilderInstall/,
          /checkClaudePlatformLiteInstall/,
          /checkClaudeFoundationAutoUpdate/,
          /checkClaudePlatformUninstall/,
          /--platform=\$\{platform\}/,
          /reports Claude platform install/,
          /reports Claude platform builder install/,
          ...
          /enterpriseDjangoVueRoutingChecks/,
          /Enterprise Django\/Vue routing proof/,
          /personaFoundationMatrixChecks/,
          /complete persona foundation\/orchestration matrix/,
          /Claude builder fixture produced[\s\S]{0,260}complete persona foundation\/orchestration matrix/,
          /root foundation activation/,
          /Claude foundation auto-update fixture/,
          /approved superpowers\/context-mode foundations only/,
          ...
          /claudeVerificationAuditTokenChecks/,
          /claudeQaAuditTokenChecks/,
          /QA and base\/specialized reviewer audit tokens/,
          /executable generated hooks and task checker/,
          /executable non-policy hooks/,
          /post-install Claude platform doctor coverage/,
          /post-install Claude builder doctor coverage/,
          /post-install Claude platform lite doctor coverage/,
          /only builder-heavy artifacts/,
          /no floor configs/,
    ...
    textChecks: [
      ...
      },
      {
        ...
        patterns: [
          ...
          /superpowers:subagent-driven-development/i,
          /superpowers:verification-before-completion/i,
          /context-mode[\s\S]{0,220}(file-backed logs|bulk context|large logs|broad searches)/i,
        ],
      },
      {
      ...
      },
      {
        ...
        patterns: [
          ...
          /checkCodexFloor/,
          /checkCodexThrift/,
          /checkCodexFoundationAutoUpdate/,
          ...
          /personaFoundationMatrixChecks/,
          /complete persona foundation\/orchestration matrix/,
          /Codex builder artifacts[\s\S]{0,260}complete persona foundation\/orchestration matrix/,
          /root foundation activation/,
          /Codex foundation auto-update fixture/,
          /approved superpowers\/context-mode foundations only/,
          /expectStackRoles/,
          /dispatchSequential/,
