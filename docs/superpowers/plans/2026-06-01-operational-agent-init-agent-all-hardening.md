...
- `node scripts/release-audit.mjs`: Claude 37/37 and Codex 44/44 readiness checks passing, including the final `scripts/release-smoke.sh` gate contract.
...
- `./scripts/release-smoke.sh --fast --with-live-cli`: 425/425 passing with Claude Code and Codex CLI live probes.
