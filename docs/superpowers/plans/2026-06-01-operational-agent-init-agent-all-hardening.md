...
- `node scripts/release-audit.mjs`: Claude 38/38 and Codex 45/45 readiness checks passing, including the final `scripts/release-smoke.sh` gate contract and public CLI executable/shebang packaging.
