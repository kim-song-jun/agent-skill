...
- `node scripts/release-audit.mjs`: Claude 54/54 and Codex 60/60 readiness checks passing, including the final `scripts/release-smoke.sh` gate contract, doctor recovery guidance, Codex floor-conditional language guidance, Claude companion root guidance, Codex thrift advisory summariser contract, and public CLI executable/shebang packaging.
