...
- `node --test`: 1729/1729 passing.
- `./scripts/release-smoke.sh --fast --with-live-cli`: 393/393 passing with Claude Code and Codex CLI live probes.
- `node scripts/sync-lib.mjs --check`: 40 vendored files match source.
