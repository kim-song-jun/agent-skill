...
- `node --test`: 1706/1706 passing.
- `./scripts/release-smoke.sh --fast --with-live-cli`: 347/347 passing with Claude Code and Codex CLI live probes.
