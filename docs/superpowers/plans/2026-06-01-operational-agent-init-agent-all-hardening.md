...
- `node --test`: 1718/1718 passing.
- `./scripts/release-smoke.sh --fast --with-live-cli`: 364/364 passing with Claude Code and Codex CLI live probes.
