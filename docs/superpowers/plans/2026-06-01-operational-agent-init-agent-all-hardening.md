...
- `node --test`: 1719/1719 passing.
- `./scripts/release-smoke.sh --fast --with-live-cli`: 365/365 passing with Claude Code and Codex CLI live probes.
