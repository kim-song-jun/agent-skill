...
**Date:** 2026-05-18
**Last refreshed:** 2026-06-02 for the release-smoke verified Claude plugin marketplace/install and Codex exec surfaces, Claude terminal install-platform operational/lite fixture coverage, Claude/Codex install→uninstall release fixtures, Codex builder/floor/thrift/debug release fixture runtime probes, stack-specific Codex sequential role dispatch proof, and Claude/Codex command-surface audit
...
- Fresh Claude marketplace, Claude terminal `install-platform.sh --platform=claude` operational/lite, Claude/Codex direct operational/lite, Claude/Codex install→uninstall roundtrips, and Codex builder/floor/thrift/debug git fixtures through the release fixture smoke gate.
