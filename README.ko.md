...
- **변경 히스토리** — [CHANGELOG.md](CHANGELOG.md) 참조. 2037 tests, 모두 통과.
...
버전: `harness-builder` `v0.6.17`, `harness-floor` `v0.6.17`, 나머지 설치 가능한 `agent-skill` 플러그인 17개도 같은 release train의 `v0.6.17`로 배포합니다. 내부 artifact/config schema version은 별도의 호환성 계약으로 유지됩니다.
