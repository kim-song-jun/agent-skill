...
- **변경 히스토리** — [CHANGELOG.md](CHANGELOG.md) 참조. 1605 tests, 모두 통과.
...
| 레이어 | 상태 | 비고 |
|---|---|---|
| Unit/integration 테스트 | ✅ **1605/1605 통과** | Mock toolCaller + 격리된 lib 테스트; release-doc, policy, Codex hook-schema, task-ledger, visual-qa 회귀 포함 |
