...
- **Change history** — see [CHANGELOG.md](CHANGELOG.md). 2026 tests, all green.
...
Versioning: `harness-builder` at `v0.6.16`, `harness-floor` at `v0.6.16`, and the other 17 installable `agent-skill` plugins at `v0.6.16` on the same release train. Internal artifact/config schema versions remain separate compatibility contracts.
