...
- **Change history** — see [CHANGELOG.md](CHANGELOG.md). 2021 tests, all green.
...
Versioning: `harness-builder` at `v0.6.14`, `harness-floor` at `v0.6.14`, and the other 17 installable `agent-skill` plugins at `v0.6.14` on the same release train. Internal artifact/config schema versions remain separate compatibility contracts.
