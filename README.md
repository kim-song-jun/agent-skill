...
Versioning: `harness-builder` at `v0.6.8`, `harness-floor` at `v0.6.8`, and the other 17 installable `agent-skill` plugins at `v0.6.8` on the same release train. Internal artifact/config schema versions remain separate compatibility contracts.
