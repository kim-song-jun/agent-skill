...
- **Change history** — see [CHANGELOG.md](CHANGELOG.md). 2283 tests, all green.
...
Versioning: `harness-builder` at `v0.7.6`, `harness-floor` at `v0.7.6`, and the other 17 installable `agent-skill` plugins at `v0.7.6` on the same release train. Internal artifact/config schema versions remain separate compatibility contracts.
