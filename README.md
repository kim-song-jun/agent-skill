...
- **Change history** — see [CHANGELOG.md](CHANGELOG.md). 2282 tests, all green.
...
Versioning: `harness-builder` at `v0.7.5`, `harness-floor` at `v0.7.5`, and the other 17 installable `agent-skill` plugins at `v0.7.5` on the same release train. Internal artifact/config schema versions remain separate compatibility contracts.
