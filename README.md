...
- **Change history** — see [CHANGELOG.md](CHANGELOG.md). 2011 tests, all green.
...
Versioning: `harness-builder` at `v0.6.13`, `harness-floor` at `v0.6.13`, and the other 17 installable `agent-skill` plugins at `v0.6.13` on the same release train. Internal artifact/config schema versions remain separate compatibility contracts.
