...
Versioning: `harness-builder` at `v0.7.11`, `harness-floor` at `v0.7.11`, and the other 17 installable `agent-skill` plugins at `v0.7.11` on the same release train. Internal artifact/config schema versions remain separate compatibility contracts.
