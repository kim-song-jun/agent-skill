...
- **Change history** — see [CHANGELOG.md](CHANGELOG.md). 1639 tests, all green.
...
| Layer | Status | Note |
|---|---|---|
| Unit/integration tests | ✅ **1639/1639 passing** | Mock toolCallers + isolated lib tests; release-doc, policy, Codex hook-schema, task-ledger, Codex exec, release-audit, and visual-qa regressions |
