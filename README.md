...
Versioning: `harness-builder` at `v0.7.1`, `harness-floor` at `v0.7.1`, and the other 17 installable `agent-skill` plugins at `v0.7.1` on the same release train. Internal artifact/config schema versions remain separate compatibility contracts.
