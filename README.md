...
- **Change history** — see [CHANGELOG.md](CHANGELOG.md). 1642 tests, all green.
...
| Layer | Status | Note |
|---|---|---|
| Unit/integration tests | ✅ **1642/1642 passing** | Mock toolCallers + isolated lib tests; release-doc, policy, Codex hook-schema, task-ledger, Codex exec, release-audit, release-fixture-smoke, and visual-qa regressions |
