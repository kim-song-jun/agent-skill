...
- Added release-fixture coverage for the terminal Claude project bootstrap path, proving `install-platform.sh --platform=claude` produces the operational scaffold, runs the post-install doctor, and leaves HOME unpatched.
