...
- Codex debug 포트를 마켓플레이스, Codex 설치 그룹, `install-platform.sh --platform=codex --theme=all|debug`, release audit, release smoke, 공개 검증 문서에 등록. 현재 suite: 1719/1719 통과; fast release smoke: 365/365 통과.
