...
- 터미널 Claude project bootstrap 경로에 release fixture coverage를 추가해 `install-platform.sh --platform=claude`가 operational scaffold를 만들고 post-install doctor를 실행하며 HOME을 패치하지 않음을 증명.
